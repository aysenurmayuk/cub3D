...
C_SRC = lib/GNL/get_next_line.c src/cub3d.c src/textures_control.c src/textures_control_2.c src/map_control.c src/map_control_2.c utils/init.c utils/free.c utils/error.c
